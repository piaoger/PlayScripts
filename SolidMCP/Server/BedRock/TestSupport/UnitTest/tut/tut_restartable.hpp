 ...
 */
inline std::string escape(const std::string& orig)
{
    std::string rc;
 ...
 * Un-escapes string.
 */
inline std::string unescape(const std::string& orig)
{
    std::string rc;
    std::string::const_iterator i,e;
    i = orig.begin();
 ...
 */
inline void serialize(std::ostream& os, const tut::test_result& tr)
{
 ...
 */
inline bool deserialize(std::istream& is, tut::test_result& tr)
{
