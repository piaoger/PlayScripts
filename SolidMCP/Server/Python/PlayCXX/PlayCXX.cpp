...
///////////////////////////////////////////////////////////////////////////////
// \file PlayCXX
// \brief Implementation of PlayCXX python module
//
// It's built from one of examples provided by PyCXX.
///////////////////////////////////////////////////////////////////////////////
...
class PlayCXX_module : public Py::ExtensionModule<PlayCXX_module>
{
public:
    PlayCXX_module()
    : Py::ExtensionModule<PlayCXX_module>( "PlayCXX" ) // this must be name of the file on disk e.g. simple.so or simple.pyd
    {
        old_style_class::init_type();
        new_style_class::init_type();

        add_varargs_method("old_style_class", &PlayCXX_module::factory_old_style_class, "documentation for old_style_class()");
        add_keyword_method("func", &PlayCXX_module::func, "documentation for func()");
        add_keyword_method("make_instance", &PlayCXX_module::make_instance, "documentation for make_instance()");

        add_keyword_method("decode_test", &PlayCXX_module::decode_test, "documentation for decode_test()");
        add_keyword_method("encode_test", &PlayCXX_module::encode_test, "documentation for encode_test()");

        // after initialize the moduleDictionary will exist
        initialize( "documentation for the PlayCXX module" );
...
#if defined( PY3 )
static PlayCXX_module *simple;

extern "C" EXPORT_SYMBOL PyObject *PyInit_PlayCXX()
{
#if defined(PY_WIN32_DELAYLOAD_PYTHON_DLL)
    Py::InitialisePythonIndirectPy::Interface();
#endif

    simple = new PlayCXX_module;
    return simple->module().ptr();
}

// symbol required for the debug version
extern "C" EXPORT_SYMBOL PyObject *PyInit_PlayCXX_d()
{ 
...
extern "C" EXPORT_SYMBOL void initPlayCXX()
{
#if defined(PY_WIN32_DELAYLOAD_PYTHON_DLL)
    Py::InitialisePythonIndirectPy::Interface();
#endif
...
// symbol required for the debug version
extern "C" EXPORT_SYMBOL void initPlayCXX_d()
{ 
    initPlayCXX();
}
#endif
